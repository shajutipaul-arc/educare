...
const uri = "mongodb+srv://eduCare:XCRcGUPPigoDlevU@cluster0.vabrqqs.mongodb.net/?retryWrites=true&w=majority";
...
async function run() {
    try {
        ...
        //  client.connect();
        const classesCollection = client.db("eduCare").collection("classes");
        const instructorCollection = client.db("eduCare").collection("instructor");
        const usersCollection = client.db("eduCare").collection("users");
        const seletedCollection = client.db("eduCare").collection("seleted_classes");
        const paymentsCollection = client.db("eduCare").collection("payments");
        const enrolledCollection = client.db("eduCare").collection("enrolled_classes");
