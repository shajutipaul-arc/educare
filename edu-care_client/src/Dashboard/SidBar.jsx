...
const Sidebar = () => {
    ...
    return (
        <aside className=" w-dashboard-md p-10 h-screen fixed top-0 bottom-0 shadow-2xl">
            ...
            <h1 className="md:mt-[50vh] bg-sky-300 p-3 text-center rounded-md hover:bg-sky-400 font-bold"><Link to="/" className="flex items-center gap-3 justify-center"><IoMdArrowRoundBack />Back Home</Link></h1>
        </aside>
    );
};
