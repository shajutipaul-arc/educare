...
var Reveal = (props) => {
  ...
  if (isStringLike(children))
    return jsx4(TextReveal, { ...props, animationStyles, children: String(children) });
  if ((0, import_react_is.isFragment)(children))
    return jsx4(FragmentReveal, { ...props, animationStyles });
  return jsx4(Fragment4, { children: import_react18.Children.map(children, (node2, index) => {
    ...
    switch (node2.type) {
      case "ol":
      case "ul":
        return jsx4(ClassNames, { children: ({ cx }) => jsx4(
          node2.type,
          {
            ...node2.props,
            className: cx(className, node2.props.className),
            style: Object.assign({}, style, node2.props.style),
            children: jsx4(Reveal, { ...props, children: node2.props.children })
          }
        ) });
      case "li":
        return jsx4(
          InView,
          {
            ...
            children: ({ inView, ref }) => jsx4(ClassNames, { children: ({ cx }) => jsx4(
              node2.type,
              {
                ...node2.props,
                ref,
          ...
          InView,
          {
            ...
            children: ({ inView, ref }) => jsx4(
              "div",
              {
                ...
                children: jsx4(ClassNames, { children: ({ cx }) => jsx4(
                  node2.type,
                  {
                    ...node2.props,
                    className: cx(childClassName, node2.props.className),
  ...
  return matchIf(
    () => jsx4(
      "div",
      {
        ...
        children: children.split("").map((char2, index) => jsx4(
          "span",
          {
            css: matchIfOrNull(() => animationStyles)(inView),
            style: {
    ...
    () => jsx4(FragmentReveal, { ...props, children })
  )(cascade);
};
...
var Bounce = (props) => {
  ...
  return jsx4(Reveal, { keyframes: keyframes87, ...rest });
};
...
var JackInTheBox = (props) => {
  return jsx4(Reveal, { keyframes: jackInTheBox, ...props });
};
